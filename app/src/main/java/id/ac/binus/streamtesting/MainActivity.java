package id.ac.binus.streamtesting;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String APPLICATION_ID = "i0biIZtjEbfzmqArz0m33Q";
    private static final String API_KEY = "SVK8SsgDUjox8vhCACeWPA";
